...
<script src="manrique_uhera_wheat.js">
</script>
</head>
<body>
...
<!-- content begins -->
 <div id="main">
	<div id="right">
	  <h2>Land quality for wheat (Manrique and Uhera)</h2>
	  <br />
...
<div id="tab6">
  ...
  <div id="dispTable" style:"line-spacing:10px">
    ...
    <div>
    <span id = "rd" style = "font-size:22px;padding-right: 17em;position-left: -5px; padding-bottom:0px">Root Depth  </span>
