...
<!-- content begins -->
 <div id="main">
    <div id="right">
      <h2>Water Suitability Criteria for Irrigation: Ayers & Wiscot(1985)</h2>
      <br />
      <div>
      <form id="form1" method="POST" action="">
        <table width="759" border="0" cellpadding="5" cellspacing="10">
          <tr>
            ...
            <td width="530">
              <select name="waterShed" required="required" id="waterShed" onblur = "ayers_select_shed()">
                <option value="Select">Select</option>
                <option value="Domagor">Domagor-Pahuj</option>
                <option value="Garhkundar">Garhkundar-Dabar</option>
                <option value="Parasi">Parasi-Sindh</option>
