...
<!---Just An Experiment-->
<script src="sys_lc_ground_domagor.js" >
          ...
          <tr>
            ...
            <td width="530">
              <select name="waterShed" required="required" id="waterShed" onblur = "select_subshed()">
                ...
                <option value="Dhikouli">Dhikouli</option>
                <option value="Nayakhera">Nayakhera</option>
                <option value="Gomagor">Domagor</option>
