...
<script type="text/javascript" src="validate_wilcox.js"></script>
...
<!-- content begins -->
 <div id="main">
  <div id="right">
      <h2>Water Suitability Criteria for Irrigation: Wilcox(1955)</h2>
 ...
 Watershed : <?php echo $param[0]; ?> &nbsp &nbsp&nbsp&nbsp
    ...
    <form id="form1" method="post" action="">
      <table width="759" border="0" cellpadding="5" cellspacing="10">
        ...
        <tr>
          ...
          <td><input name="sodium" type="text" required="required" id="sodium" size="25" onchange="findClass();"/></td>
          </tr>
       <tr>
  ...
  <td width="368" style="text-align: center"><input type="button" id="bigbutton" value = "Print Result" onclick="printData('Wilcox(1955)','<?php echo $param[0] ;?>', '<?php echo $param[1] ;?>')" ></td>
