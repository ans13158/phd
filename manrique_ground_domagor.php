...
<script src = "manrique_ground_domagor.js"  > </script>
</head>
<body>
          ...
          <tr>
            ...
            <td width="530">
              <select name="subWaterShed" required="required" id="subWaterShed" onblur = "select_subshed()">
                ...
                <option value="Dhikouli">Dhikouli (Lower Reach)</option>
                <option value="Nayakhera">Nayakhera(Middle Reach)</option>
                <option value="Gomagor">Domagor(Upper Reach)</option>
    ...
    <div id="left"> 
        ...
        <li>
          <table width="368" border="0" cellpadding="0" cellspacing="5" id="menu_table">
            ...
            <tr>
              <td height="23"><a href="sic.php">Land Capability Classification</a></td>
            </tr>
            <tr>
