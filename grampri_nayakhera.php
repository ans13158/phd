...
Suitability criteria (Crop Requirements) for Gram</h2>
    ...
    <br />
     <h2>Watershed : Domagor-Pahuj  Sub-watershed : Nayakhera 
<br />
...
<ul id="tabs">
<li><a href="#" name="#tab1">Actual Yield</a></li>
</ul>
<div id="content1">
<div id="tab1">
<table width="648" border="0">
  <tr>
    <td>Region </td>
    <td><input id="place" type="text" required="required" name="places" onblur="calcPlace()"/> </td>
  </tr>

  <tr>
    <td>Expected or Actual Yeild of Crop (q/ha) :</td>
    <td><input id="actual"  type="text" required="required" name="perSlope" onblur="calcpri()" /></td>
  </tr>
  <tr>
    <td style="font-size:100%">Note That: <strong> Standard Yield of Gram is Taken as <q> 16 q/ha</q></strong></td>
  </tr>
</table>
<br><div id="result" style="font:150% bold"></div>
<h2>&nbsp;</h2>
</div>
    ...
    <div class="left_back">
        ...
        <li>
          <table width="368" border="0" cellpadding="0" cellspacing="5" id="menu_table">
            ...
            <tr>
              <td height="23"><a href="lcc_select_region.php">Land Capability Classification</a></td>
            </tr>
            <tr>
