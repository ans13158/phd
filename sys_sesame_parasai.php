...
<!-- content begins -->
 <div id="main">
	<div id="right">
	  <h2>Suitability criteria (Crop Requirements) for Sesame</h2>
	  <br />
	  <h2>Water Shed : Parasai-sindh Sub WaterShed  : Parasai Reach</h2> 
	  <br />
...
<div id="tab8">
  ...
  <div id="dispTable" style:"line-spacing:10px">
    ...
    <div>
     <span id = "l1" style = "font-size:22px;padding-right: 9.5em;position-left: -5px; padding-bottom:0px">Length of 
      Growing Season
</span>
