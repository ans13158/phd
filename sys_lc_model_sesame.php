...
<table width="680" height="35" border="0">
  <tr>
    <td width="376">Length of growing period early variety  (days)</td>
    <td width="294"><input name="length_growing_early" type="text" required="required" id="length_growing_early" onblur="callength1()" /></td>
  </tr>
  <tr>
    <td>Length of growing period medium variety  (days)</td>
    <td><input name="length_growing_medium" type="text" required="required" id="length_growing_medium" onblur="callength2()"/></td>
  </tr>
  <tr>
    <td>Length of growing period late variety  (days)</td>
    <td><input name="length_growing3" type="text" required="required" id="length_growing3" onblur="callength3()"/></td>
  </tr>
</table>
<br><div id="len6" style="font-size:150%"></div>
<p>&nbsp;</p>
</div>
<div id="tab4">
