...
<script src="manrique_uhera_groundnut.js">
</script>
</head>
<body>
...
<!-- content begins -->
 <div id="main">
	<div id="right">
	  <h2>Land quality for groundnut (Manrique and Uhera)</h2>
	  <br />
...
<table width="648" border="0">
  <tr>
    ...
    <td><input name="land_erodibility" type="text" required="required" id="land_erodibility" onblur="calcLand()" /></td>
  </tr>
</table>
...
<div id="tab2">
  <table width="681" border="0">
    ...
    <td width="373"><select name="drain3" id="texture" onblur="calcSoil()">
...
<div id="tab3">
  ...
  <tr>
    ...
    <td width="295"><select name="drain2" id="log" onblur="calcWater()">
      <option value="Select">Select</option>
...
<div id="tab6">
  ...
  <div id="dispTable" style:"line-spacing:10px">
    <div>
      <h2 align= "center" style="font-size:22px">Topography</h2>
    ...
    <span id = "le_suit" style = "font-size:22px; "> </span>
      ...
      <br>
      <h2 align= "center" style="font-size:22px">Water Avalaibility</h2>
    <div>
    <span id = "st" style = "font-size:22px;padding-right: 18em">Soil Texture</span>
    <span id = "st_data" style = "font-size:22px; padding-right: 1em "> </span>
    <span id = "st_suit" style = "font-size:22px;  "> </span>

    </div>
      <h2 align= "center" style="font-size:22px">Oxygen Avalaibility</h2>
    ...
    <br>
      <h2 align= "center" style="font-size:22px">Root Development</h2>

    <div>
    <span id = "rd" style = "font-size:22px;padding-right: 18em;position-left: -5px; padding-bottom:0px">Root Depth  </span>
    <span id = "rd_data" style = "font-size:25px; padding-right: 2em ; "> </span>
    <span id = "rd_suit" style = "font-size:22px;"> </span>

<br>
      <h2 align= "center" style="font-size:22px">Nutrient Avalaibility</h2>
    ...
    <div>
    <span id = "base" style = "font-size:25px;padding-right: 12em; padding-bottom:0px">Base Saturation</span>
    ...
    <div>
    <span id = "caco3" style = "font-size:25px;padding-right: 12em; padding-bottom:0px">Caco3 Equivalent</span>
    <span id = "caco3_data" style = "font-size:25px; padding-right: 3em "> </span>
    <span id = "caco3_suit" style = "font-size:22px"> </span>

    </div>
     
     <span id = "LuI " style = "font-size:22px;padding-right: 15em;"> <strong>LUI-fa</strong></span>
     <span id = "lui_data" style = "font-size:25px; padding-right: 2em "> </span>
...
<table width="684" height="10" border="0">
  ...
  <td width="387"><input type="button" id="bigbutton" value = "Print Result"
   onclick="printData('Parasai-Sindh', 'Parasai')" /></td>
  </tr>
</table>
</div>
</div>
