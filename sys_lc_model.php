...
<!-- content begins -->
 <div id="main">
	<div id="right">
uitability criteria (Crop Requirements) for Wheat</h2>
	  <br />
...
<br> <placeholder id="len2" style="font: 150% bold"></placeholder>
<p>&nbsp;</p>
</div>
<div id="tab4">
...
<br><div id="result" style="font-size:150%"></div>
<br><br><div id="final" style="font-size:150%"></div>
