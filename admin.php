...
<!-- content begins -->
 <div id="main">
	<div id="right">
	  <h2>Dash Board</h2><br />
      <table width="200" border="0" align="center" cellpadding="5" cellspacing="10">
        <tr>
          <td><div id="bodymiddlePan">
  <div id="middleonePan" >
	    <ul class="block" style=>
	      <li><a href="lcc.php">Land Capability Classification</a>	  </li>
	    </ul>
	  </div>
	  <div id="middletwoPan">
	    <ul class="block">
	      <li><a href="lic.php">Land Irrigability Classification</a>	    </li>
	    </ul>
	  </div>
	  <div id="middlethreePan">
	    <ul class="block">
	      <li><a href="lri.php">Land Rating Index</a>	    </li>
	    </ul>
	  </div>
	  <div id="middlefourPan">
	    <ul class="block">
	      <li><a href="sic.php">Soil Irrigability Classification</a>	    </li>
	    </ul>
	  </div>
	</tr>
	<tr>
	 <td> <div id="middleonePan">
	    <ul class="block">
	      <li><a href="wsc.php">Water Suitablity Criteria for Irrigation</a>	    </li>
	    </ul>
	  </div>
	 ...
	 <div id="middletwoPan">
	    <ul class="block">
	      <li><a href="ack.php">Acknowle-dgement</a>	    </li>
	    </ul>
	  </div>
	  <div id="middlethreePan">
	    <ul class="block">
