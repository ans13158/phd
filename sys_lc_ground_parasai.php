...
<!-- content begins -->
 <div id="main">
  <div id="right">
Suitability criteria (Crop Requirements) for Groundnut</h2>
<h2> WaterShed : Parasai-Sindh
          Sub WaterShed : Parasai</h2> 
    <br />
...
<table width="648" border="0">
  <tr>
    ...
    <td><input id="perSlope"  type="text" required="required" name="perSlope" onblur="calTopo()" /></td>
  </tr>
...
<table width="688" height="42" border="0">
  <tr>
    ...
    <td><select name="drain" id="drain" onblur="calcDrain()">
      ...
      <option value="Excessively Poorly Drained">Excessively Poorly Drained</option>
      </select></td>
  </tr>
</table>
