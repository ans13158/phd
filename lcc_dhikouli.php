...
<script src = "lcc_shed_select.js"  > </script>
</head>
<body>
      ...
      <form id="form1" method="POST" action="">
        <table width="759" border="0" cellpadding="5" cellspacing="10">
          <tr>
            ...
            <td width="530">
              <select name="subWaterShed" required="required" id="subWaterShed" onblur = "select_shed()">
                <option value="Select">Select</option>
                <option value="Domagor-Pahuj">Domagor</option>
                <option value="Garhkundar-Dabar">Garhkundar</option>
