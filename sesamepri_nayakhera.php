...
<!-- content begins -->
 <div id="main">
  <div id="right">
Suitability criteria (Crop Requirements) for Sesamenut</h2>
    <br />
    
    <br />
     <h1> Water Shed : Domagor-Pahuj   Sub WaterShed : Nayakhera </h1>
<br />
...
<table width="648" border="0">
  ...
  <tr>
    <td style="font-size:100%">Note That: <strong> Standard Yield of Sesame is Taken as <q> 6 q/ha</q></strong></td>
  </tr>
</table>
