...
<script src="sys_lc_model_sesame.js"></script>
</head>
<body>
...
<table width="648" border="0">
  <tr>
    ...
    <td><input name="per_slope" type="text" required="required" id="per_slope" onblur="calTopo()"/></td>
  </tr>
</table>
...
<table width="681" border="0">
  ...
  <tr>
    <td width="376">Length of growing period(days)</td>
    <td width="294"><input name="length_growing_early" type="text" required="required" id="length_growing_early" onblur="callength1()" /></td>
  </tr>
</table>
...
<table width="692" height="84" border="0">
  <tr>
    ...
    <td width="492"><select name="drain2" id="texture" onblur="calcSoil()">
      <option value="Select">Select</option>
  ...
  <tr>
    ...
    <td><input name="caco3" type="text" required="required" id="caco3" onblur="callcarbonate()"/></td>
  </tr>
...
<table width="687" height="89" border="0">
  <tr>
    ...
    <td width="467"><input name="cec" type="text" required="required" id="cec" onblur="Cec()" /></td>
  </tr>
  <tr>
...
<table width="692" height="67" border="0">
  <tr>
    ...
    <td width="464"><input name="ec_dsm" type="text" required="required" id="ec_dsm" onblur="callcec()"/></td>
  </tr>
  <tr>
    <td>Na concentration (Sodicity in %):</td>
    <td><input name="na_conc" type="text" required="required" id="na_conc"  onblur="calNA()"/></td>
  </tr>
  <tr>
...
<br><div id="na" style="font-size:150%" ></div>
...
<div id="tab8">
  ...
  <div id="dispTable" style:"line-spacing:10px">
    ...
    <div>
    <span id = "l1" style = "font-size:22px;padding-right: 11.5em;position-left: -5px; padding-bottom:0px">Length Growing 
Period </span>
    <span id = "l1_data" style = "font-size:25px; padding-right: 1.5em ; "> </span>
    <span id = "l1_suit" style = "font-size:22px;padding-right: 1.5em"> </span>
  </div>
<br>
      <h2 align= "center"><strong>Water Availability</strong></h2>

   <div>
    <span id = "w1" style = "font-size:22px;padding-right: 6em;position-left: -5px; padding-bottom:0px">Available Water
