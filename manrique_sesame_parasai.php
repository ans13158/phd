...
<script src="manrique_uhera_sesame.js">
</script>
</head>
<body>
...
<!-- content begins -->
 <div id="main">
	<div id="right">
	  <h2>Land quality for sesame (Manrique and Uhera)</h2>
	  <br />
...
<div id="tab6">
  ...
  <div id="dispTable" style:"line-spacing:10px">
    ...
    <div>
    <span id = "dr" style = "font-size:22px;padding-right: 19em">Drainage</span>
    <span id = "dr_data" style = "font-size:22px; padding-right: 3em "> </span>
    <span id = "dr_suit" style = "font-size:22px"> </span>
    <br>
      <span id = "wl" style = "font-size:22px;padding-right: 17em">Water Logging</span>
    <span id = "wl_data" style = "font-size:22px; padding-right: 1.5em "> </span>
...
<br>
    ...
    <span id = "caco3_suit" style = "font-size:22px"> </span>
     ...
     <span id = "LuI " style = "font-size:22px;padding-right: 18em;"> <strong>LUI-fa</strong></span>
