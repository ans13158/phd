  ...
  <tr>
   <td>Drainage:</td>
    <td><select name="drain" id="drain" onblur="calcDrain()">
      ...
      <option value="Well Drained">Good</option>
      <option value="Moderately Well Drained">Moderate</option>
      <option value="Imperfectly Drained">Imperfect</option>
      <option value="Poorly Drained">Poor and aeric</option>
      <option value="Excessively Poorly Drained">Very Poor</option>
      </select></td> 
  </tr>
</table>
