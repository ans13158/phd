...
<script src = "ayers_garhkundar.js"  > </script>
</head>
<body>
      ...
      <form id="form1" method="POST" action="">
        <table width="759" border="0" cellpadding="5" cellspacing="10">
          <tr>
            ...
            <td width="530">
              <select name="sub-watershed" required="required" id="sub-watershed" onblur = "select_subshed()">
                <option value="Select">Select</option>
                <option value="Lower Reach">Lower Reach</option>
                <option value="Middle Range">Middle Reach</option>
                <option value="Upper Range">Upper Reach</option>
