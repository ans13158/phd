...
<link href="jQueryAssets/jquery.ui.core.min.css" rel="stylesheet" type="text/css" media="all" />
<link href="jQueryAssets/jquery.ui.theme.min.css" rel="stylesheet" type="text/css" media="all"/>
<script src="jQueryAssets/jquery-1.8.3.min.js" type="text/javascript"></script>
<script type="text/javascript" src="js/jquery-1.11.0.min.js"></script>
<script type="text/javascript" src="js/jquery.leanModal.min.js"></script>

<script type="text/javascript" src="validate_ayers.js"></script>

<link rel="stylesheet" href="http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.min.css" media="all" />
<link type="text/css" rel="stylesheet" href="css/style.css" media="all"/>
<link href="style.css" rel="stylesheet" type="text/css" media="all"/>
<link type="text/css" rel="stylesheet" href="stylebuttons.css" media="all">
<style>
a:link {
...
<!-- content begins -->
 <div id="main">
  <div id="right">
      <h2>Water Suitability Criteria for Irrigation: Ayers & Westcot(1985)</h2>
  ...
  Sub-watershed : <?php echo $param[1] ; ?> </h3></strong><br><br>  
    ...
    <form id="form1" method="post" action="">
      <table width="759" border="0" cellpadding="5" cellspacing="10">
        <tr>
          <td style="font-size: 16px">Electrical Conductivity(Salinity) (μS/cm):</td>
          <td><input name="conductivity" type="text" required="required" id="conductivity" size="25" /></td>
          </tr>

          <tr>
          <td style="font-size: 16px">Total Dissolved Solids (Salinity) (mg/l):</td>
          <td><input name="dissolvedSolid" type="text" required="required" id="dissolvedSolid" size="25" /></td>
          </tr>

          <tr>
          <td style="font-size: 16px">Sodium Absorption Ratio (Specific ion toxicity) (%):</td>
          <td><input name="sodium" type="text" required="required" id="sodium" size="25" /></td>
          </tr>

          <tr>
          <td style="font-size: 16px">Chloride (Specific ion toxicity) (me/l) :</td>
          <td><input name="chloride" type="text" required="required" id="chloride" size="25" /></td>
          </tr>
        <tr>
          <td style="font-size: 16px"> Boron(Specific ion toxicity) (mg/l)</td>
          <td><input name="boron" type="text" required="required" id="boron" size="25" onchange="findClass();"/></td>
          </tr>
       <tr>
          <td>Suitability Class:</td>
