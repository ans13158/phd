...
<!---Just An Experiment-->
<script src="sys_lc_ground_garkhundar.js" >
          ...
          <tr>
            ...
            <td width="530">
              <select name="waterShed" required="required" id="waterShed" onblur = "select_subshed()">
                ...
                <option value="Lower">Lower Reach</option>
                <option value="Middle">Middle Reach</option>
                <option value="Upper">Upper Reach</option>
