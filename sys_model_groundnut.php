...
<script src="sys_model_groundnut.js">
</script>
</head>
<body>
...
<table width="688" height="42" border="0">
  <tr>
    <td>Drainage:</td>
    <td><select name="drain" id="drained" onblur="calcDrain()">
...
<br><div id="drain" style="font-size:150%"></div> 
<h2>&nbsp;</h2>
</div>
<div id="tab5">
...
<table width="687" height="89" border="0">
  <tr>
    ...
    <td width="467"><input name="cec_subsoil" type="text" required="required" id="cec_subsoil" onblur="calCec()"/></td>
  </tr>
  <tr>
