...
<!-- content begins -->
 <div id="main">
	<div id="right">
Suitability criteria (Crop Requirements) for Wheat</h2>
	  <br />
	  
	  <br />
    <h2>Watershed : Parasai-Sindh Sub-watershed : Parasai</h2>   
...
<table width="648" border="0">
  <tr>
    ...
    <td><input id="per_slope"  type="text" required="required" name="per_slope" onblur="calTopo()" /></td>
  </tr>
  
</table>
<br><div style="font-size:150%" id="land"></div>
<h2>&nbsp;</h2>
</div>
<div id="tab2">
...
<table width="681" border="0">
  <tr>
    ...
    <td width="373"><input  type="text" name="rainfall" required="required" id="rainfall" onblur="calrain1()" /></td>
  </tr>
  <tr>
    <td>Mean Temperature during growing season (&deg;C):</td>
    <td><input  type="text" name="temp" required="required" id="temp" onblur="calmean1()" /></td>
  </tr>
    <tr>
    <td width="266">Length of growing season (days)</td>
    <td width="404"><input name="length_growing" type="text" required="required" id="length_growing_early" onblur="callength1()"/></td>
  </tr>
</table>
<br><div id="mean1" style="font-size:150%"></div>
<p>&nbsp;</p>
</div>
<div id="tab3"> 
...
<table width="680" height="35" border="0">
  <tr>
    <td width="266">Available Water Holding Capacity (%)</td>
...
<table width="688" height="42" border="0">
  <tr>
    ...
    <td><select name="drain" id="drain" onblur="calcDrain()">
      ...
      <option value="Poor Aeric">Poor Aeric</option>
      <option value="Very Poor">Very Poor</option>
      </select></td>
  </tr>
</table>
<br><div  style="font-size:150%; text-shadow:0 -1px 0px rgba(0, 0, 0, 0.3)" id="drained"></div>
<h2>&nbsp;</h2>
</div>
<div id="tab5">
<table width="692" height="84" border="0">
  ...
  <tr>
    ...
    <td><input name="caco3" type="text" required="required" id="caco3" onblur= "calcal()" /></td>
  </tr>
</table>
<br><div id="calc" style="font-size:150%"></div>
<h2>&nbsp;</h2>
</div>
<div id="tab6">
...
<br><div id="ph01" style="font-size:150%"></div>
<h2>&nbsp;</h2>
</div>
<div id="tab7">
<table width="692" height="67" border="0">
  ...
  <tr>
    ...
    <td><input name="na_conc" type="text" required="required" id="na_conc" onblur="calnaConc()" /></td>
  </tr>
  <tr>
    <td><button type="button" onclick="calLRI();">Calculate LRI<button></td>
  </tr>  
</table>
<br><div id="na01" style="font-size:150%"></div>
...
<div id="tab8">
  ...
  <div id="dispTable" style:"line-spacing:10px">
    ...
    <div>
    <span id = "mt" style = "font-size:22px;padding-right: 14em">Mean Temperature</span>
    ...
    <div>
    <span id = "l1" style = "font-size:22px;padding-right: 12em;position-left: -5px; padding-bottom:0px">Length Growing 
Period  </span>
    <span id = "l1_data" style = "font-size:25px; padding-right: 2em ; "> </span>
    ...
    <div>
    <span id = "w1" style = "font-size:22px;padding-right: 8em;position-left: -5px; padding-bottom:0px">Available Water
     Holding Capacity</span>
...
<br>
    ...
    <div>
    <span id = "cec" style = "font-size:25px;padding-right: 17em; padding-bottom:0px">C.E.C</span>
    ...
    <div>
    <span id = "org" style = "font-size:25px;padding-right: 12em; padding-bottom:0px">Organic Carbon</span>
    ...
    <div>
    <span id = "ph" style = "font-size:25px;padding-right: 17em; padding-bottom:0px">pH</span>
    ...
    <span id = "na_suit" style = "font-size:22px"> </span>
     ...
     <span id = "LRI " style = "font-size:22px;padding-right: 15em;"> <strong>LRI</strong></span>
     <span id = "lri_data" style = "font-size:25px; padding-right: 1em "> </span>
...
<table width="684" height="10" border="0">
  ...
  <td width="387"><input type="button" id="bigbutton" value = "Print Result" onclick="printData('Parasai-Sindh', 'Parasai')" /></td>
  </tr>
</table>
</div>
</div>
