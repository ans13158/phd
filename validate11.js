...
else if (soild.value == "Deep" && $result!=1)
{
...
else if (drain.value == "Moderately Drained" && && $result!=1)
{
...
else if (surtex.value == "sicl" || surtex.value == "cl" || surtex.value == "sl" || surtex.value == "sil" || surtex.value == "scl" || surtex.value == "fsl" || surtex.value == "Nil" && && $result!=1)
{
...
else if (erscls.value == "Nil" && && $result!=1)
{
...
else if (salinity.value == "Moderate" && && $result!=1)
{
...
else if ((rain.value == "" || rain.value == 0) && && $result!=1)
{
...
else if (soild.value == "Moderately Deep" && && $result!=1 && && $result!=2)
{
