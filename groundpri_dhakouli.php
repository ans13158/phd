...
Suitability criteria (Crop Requirements) for Groundnut</h2>
    ...
    <br />
     <h2>Watershed : Domagor   Sub WaterShed : Dhikouli 
<br />
...
<tr>
  ...
  <tr>
    <td>Expected or Actual Yield of Crop (q/ha):</td>
    <td><input id="actual"  type="text" required="required" name="perSlope" onblur="calcpri()" /></td>
  </tr>
  <tr>
    <td style="font-size:100%">Note That: <strong> Standard Yield of Groundnut is Taken as <q> 6 q/ha</q></strong></td>
  </tr>
</table>
