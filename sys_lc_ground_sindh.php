...
<!---Just An Experiment-->
<script src="sys_lc_ground_parasai.js" >
 ...
 <form id="form1" method="POST" action="">
        <table width="759" border="0" cellpadding="5" cellspacing="10">
          <tr>
            ...
            <td width="530">
              <select name="waterShed" required="required" id="waterShed" onblur = "select_subshed()">
                <option value="Select">Select</option>
                <option value="Bachhouni">Bachhouni Reach</option>
                <option value="Chatpur">Chhatpur Reach</option>
                <option value="Parasai">Parasai Reach</option>
