...
<script src="sys_lc_model_ground.js">
</script>
</head>
<body>
...
<!-- content begins -->
 <div id="main">
	<div id="right">
	  <h2>Soil-Site Suitability criteria (Crop Requirements) for Groundnut</h2>
	  <br />
...
<table width="680" height="35" border="0">
  <tr>
    <td width="309">Length of growing period bunch variety(days):</td>
    <td width="361"><input name="length_growing_bunch" type="text" required="required" id="length_growing_bunch" onblur="callength1()" /></td>
  </tr>
  <tr>
    <td>ength of growing period spreading variety(days):</td>
    <td><input name="length_growing_spreading" type="text" required="required" id="length_growing_spreading" onblur="callength2()" /></td>
  </tr>
</table>
...
<table width="692" height="84" border="0">
  <tr>
    ...
    <td width="492"><select name="texture" id="texture" onblur="calcSoil()">
      ...
      <option value="c<60">c</option>
      <option value="s">s</option>
      <option value="lfs">lfs</option>
      <option value="ls">ls</option>
      <option value="lcs">lcs</option>
      <option value="c>60%">sics</option>
      <option value="fs">fs</option>
      <option value="s">lcs</option>
      <option value="lcs">lcs</option>
...
<table width="687" height="89" border="0">
  <tr>
    ...
    <td width="467"><input name="cec_subsoil" type="text" required="required" id="cec" onblur="Cec()"/></td>
  </tr>
  <tr>
