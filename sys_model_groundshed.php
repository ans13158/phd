...
<script src = "sys_model_gram_shed.js"  > </script>
</head>
<body>
          ...
          <tr>
            ...
            <td width="530">
              <select name="waterShed" required="required" id="waterShed" onblur = "select_shed()">
                ...
                <option value="Domagor">Domagor</option>
                <option value="Garkhundar">Garkhundar</option>
                <option value="Parasai_Sindh">Parasai-Sindh</option>
