...
<script type="text/javascript" src="validate_richards.js"></script>
...
<!-- content begins -->
 ...
 Watershed : <?php echo $param[0]; ?> &nbsp &nbsp&nbsp&nbsp
  ...
  <td width="368" style="text-align: center"><input type="button" id="bigbutton" value = "Print Result" onclick="printData('Richards(1954)','<?php echo $param[0] ;?>', '<?php echo $param[1] ;?>')" ></td>
