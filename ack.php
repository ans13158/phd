...
<!-- content begins -->
 <div id="main" style="background color: grey">
  ...
  <pre>
   <p style="font-size:180%"> Name     :  <strong>PRATAP KUMAR MISTRY</strong> <br> Id Number: <strong> 26277 </strong> </p>

  </pre>
   </h3>

  <br><br><br>
  <h2 style="color:black"><b>TECHNICAL SUPPORT :</b> </h2>
  <p style="font-size:130%"> <strong> Name: ANSHUL AGRAWAL <br>
                                      Branch: COMPUTER ENGINEERING<br>
                                      COLLEGE OF TECHNOLOGY , GBPUAT<br>
    ...
    <div class="left_back">
      <table width="368" border="0" cellspacing="5" cellpadding="5" style="border: 2px solid #000066;" id="menu_table">
            ...
            <tr>
              ...
              <td style="font-size: 18px">+91-9410516774</td>
              </tr>
              </table>
    </div>
