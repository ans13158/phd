...
function wheatLimitOrganic(organicCarb)
  {
    ...
    wheatLimitOrganic.prototype.interPolate=function()
    {
      ...
      if(this.organicCarb>=2 && this.organicCarb<=4)
      {
        this.valInter=90+2.5*(this.organicCarb);
        this.disp(this.valInter);
      }

      else if(this.organicCarb>=1.5 && this.organicCarb<2)
      {
  

        this.valInter=55+ 20*(this.organicCarb);
        this.disp(this.valInter);
      }

        else if(this.organicCarb>=1 && this.organicCarb<1.5)
      {
        this.valInter= 50*(this.organicCarb) + 10;
        this.disp(this.valInter);
      }

      else if(this.organicCarb>=0.5 && organicCarb<1)
      {
        this.valInter= 30*(this.organicCarb) + 30;
        this.disp(this.valInter);
      }
      
      else if(this.organicCarb<0.5 && this.organicCarb > 0)
      {
        this.valInter= 44.99;
        this.disp(this.valInter);
      }
