...
<script src = "select_shed.js"  > </script>
</head>
<body>
    ...
    <div id="right">
      ...
      <form id="form1" method="POST" action="">
        <table width="759" border="0" cellpadding="5" cellspacing="10">
          <tr>
            <td width="179" style="font-size: 16px">Select WaterShed:</td>
            <td width="530">
              <select name="waterShed" required="required" id="waterShed" onblur = "select_shed()">
