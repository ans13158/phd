 ...
 <div id="main">
	<div id="right">
	  ...
	  <form id="form1" method="post" action="">
	    <div id="Accordion1">
	      <h3><a href="#">Select Model</a></h3>
	      <div>
	        <p><a href="richards.php">According to Richards(1954)</a></p>
	        <p><a href="wilcox.php">According to Wilcox(1955)</a></p>
	        <p><a href="ayers.php">According to Ayers and Wescot(1985)</a></p>
